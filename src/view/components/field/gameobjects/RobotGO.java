...
import view.components.field.core.shapes.Arc3D;
import view.components.field.gameobjects.contextmenus.RobotInfoContextMenu;
...
public class RobotGO extends GameObject {
	...
	public void Initialize() {
		...
		// Add our model to the model group
