package view.components.field;

import view.components.field.core.game.Game;
import view.components.field.core.math.Vector3f;
import view.components.field.gameobjects.FieldGO;
import view.components.field.gameobjects.PenaltySpotGO;
import view.components.field.gameobjects.RobotGO;
import view.components.field.gameobjects.SkyboxGO;
...
public class FieldGame extends Game {
	...
	public FieldGame(Parent root, double width, double height, boolean depthBuffer, SceneAntialiasing antiAliasing, Scene mainScene) {
		
		// Initialize super class
		super(root, width, height, depthBuffer, antiAliasing, mainScene);
