	...
	public Event getNewEvent() {
		...
		if (ball.getSpeed() < 50.0) {
			...
			if (previousBallOwner instanceof Ally) {
				...
				else if (previousBallOwner != null && currentBallOwner != null
						&& previousBallOwner.getRobotId() != currentBallOwner.getRobotId()) //Enemy retains possession of ball
