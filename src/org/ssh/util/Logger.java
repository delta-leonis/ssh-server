...
public class Logger extends java.util.logging.Logger {
	...
	/**
	 * gets a org.ssh.util.logger that uses the classname of the class that called this method using the StackTrace
	 * 
	...
	/**
	 * get a java.util.logging.logger and cast it to org.ssh.util.logger for String.format functionality
	 * 
     ...
     * 
     * If the logger is currently enabled for the SEVERE message level then the given message is forwarded to all the registered org.ssh.senders Handler objects.
	 * @param  format
     *         A format string</a>
     *
     * @param  args
     ...
     * 
     * If the logger is currently enabled for the INFO message level then the given message is forwarded to all the registered org.ssh.senders Handler objects.
	 * @param  format
     *         A format string</a>
     *
     * @param  args
     ...
     * 
     * If the logger is currently enabled for the FINE message level then the given message is forwarded to all the registered org.ssh.senders Handler objects.
	 * @param  format
     *         A format string</a>
     *
     * @param  args
     ...
     * 
     * If the logger is currently enabled for the FINER message level then the given message is forwarded to all the registered org.ssh.senders Handler objects.
	 * @param  format
     *         A format string</a>
     *
     * @param  args
     ...
     * 
     * If the logger is currently enabled for the FINEST message level then the given message is forwarded to all the registered org.ssh.senders Handler objects.
	 * @param  format
     *         A format string</a>
     *
     * @param  args
     ...
     * 
     * If the logger is currently enabled for the CONFIG message level then the given message is forwarded to all the registered org.ssh.senders Handler objects.
	 * @param  format
     *         A format string</a>
     *
     * @param  args
     ...
     * 
     * If the logger is currently enabled for the WARNING message level then the given message is forwarded to all the registered org.ssh.senders Handler objects.
	 * @param  format
     *         A format string</a>
     *
     * @param  args
