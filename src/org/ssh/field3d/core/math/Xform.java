...
public class Xform extends Group {
     ...
     *
     * @param x The angle to rotate around x-axis.
     * @param y The angle to rotate around y-axis.
     * @param z The angle to rotate around z-axis.
     */
     ...
     *
     * @param x The new rotation angle around the x-axis.
     */
     ...
     *
     * @param y The new rotation angle around the y-axis.
     */
     ...
     *
     * @param z The new rotation angle around the z-axis.
     */
     ...
     * Sets the scale of the transformation.
     *
     * @param x The new scale of the x-axis.
     * @param y The new scale of the y-axis.
     * @param z The new scale of the z-axis.
     */
     ...
     *
     * @param x The new translation on the x-axis.
     * @param y The new translation on the y-axis.
     */
     ...
     * @param x The new translation on the x-axis.
     * @param y The new translation on the y-axis.
     * @param z The new translation on the z-axis.
     */
