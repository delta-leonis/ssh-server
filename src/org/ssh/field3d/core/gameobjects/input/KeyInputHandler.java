...
public class KeyInputHandler extends GameObject {
     ...
     *
     * @param keyCode The {@link KeyCode key} to check.
     ...
     *
     * @param keyCode The {@link KeyCode} to set the state of.
     * @param state   The state of the button, true for pressed, false for not pressed.
     */
