...
public class MouseInputHandler extends GameObject {
     ...
     *
     * @param buttonNumber The number of the button, 0 for left, 1 for mid and 2 for right.
     ...
     *
     * @param value The new maximal mouse wheel value.
     */
     ...
     *
     * @param value The new minimal mouse wheel value.
     */
     ...
     *
     * @param value The new mouse wheel x value.
     */
     ...
     *
     * @param value The new mouse wheel y value.
     */
     ...
     *
     * @param value The new mouse x-coordinate.
     */
     ...
     *
     * @param value The new mouse y-coordinate.
     */
     ...
     *
     * @param mouseEvent the new mouse button states
     */
