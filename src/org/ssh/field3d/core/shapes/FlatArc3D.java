...
public class FlatArc3D {
     ...
     *
     * @param startAngleRad The starting angle of the arc in radians.
     * @param endAngleRad   The ending angle of the arc.
     ...
     * @param diameter     The diameter of the arc.
     * @param thickness    The thickness of the arc.
     * @param numDivisions The number of divisions in the arc.
