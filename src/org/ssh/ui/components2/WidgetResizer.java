...
/**
 * Class that can be used to display an overlaying resize icon on a widget or other {@link UIComponent2}.
 * It displays an 24x24 px icon that, when dragged, lets the given content grow or shrink.
 */
public class WidgetResizer extends UIComponent2<GridPane> {
