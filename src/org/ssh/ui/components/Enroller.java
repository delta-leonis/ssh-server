...
public class Enroller<N extends Region> extends BorderPane {
     ...
     *
     * @param content               {@link UIComponent} which should be displayed in the 3enroller
     * @param extendDirection       {@link ExtendDirection} to indicate if the enroller expands
     *                              down, up, left or right
     * @param fixedSizeProperty     {@link ReadOnlyDoubleProperty heightProperty} or
     *                              {@link ReadOnlyDoubleProperty widthProperty} of the
     *                              NON-extending directionto bind the enroller to (e.g. from a
     *                              pane it is put in)
     * @param collapsedSizeProperty {@link ReadOnlyDoubleProperty heightProperty} or
     *                              {@link ReadOnlyDoubleProperty widthProperty} for the size when
     *                              collapsed (if constandly 0.0, you should use the other
     *                              constructor)
     * @param extendedSizeProperty  {@link ReadOnlyDoubleProperty heightProperty} or
     *                              {@link ReadOnlyDoubleProperty widthProperty} for the extended
     *                              size
     * @param buttonIncluded        boolean for if there should be a {@link Button} included in
     ...
     *
     * @param content              {@link UIComponent} which should be displayed in the enroller
     * @param extendDirection      {@link ExtendDirection} to indicate if the enroller expands
     *                             down, up, left or right
     * @param fixedSizeProperty    {@link ReadOnlyDoubleProperty heightProperty} or
     *                             {@link ReadOnlyDoubleProperty widthProperty} of the
