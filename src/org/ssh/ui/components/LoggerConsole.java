...
public class LoggerConsole extends UIComponent {
     ...
     * {@link LogginTab} for each package as displayed group of {@link Logger}s.
     */
    public LoggerConsole() {
        // Call super constructor with right fxml file
        super("loggerconsole", "loggerconsole.fxml");
        // Bind the height and width property for correct resizing
        ...
        tabPane.getTabs().add(new Tab("all", new LoggingTab("all", Logger.getLogger("org.ssh"))));
        ...
        for (int i = 0; i < tabNames.size(); i++)
            tabPane.getTabs().add(new Tab(tabNames.get(i),
                    new LoggingTab(tabNames.get(i), Logger.getLogger("org.ssh." + tabNames.get(i)))));
    ...
    protected class LoggingTab extends UIComponent {
        ...
        public LoggingTab(String name, Logger logger) {
            // Call super constructor with right fxml file
            super("logtab " + name, "loggertab.fxml");
            // Bind the height and width property for correct resizing
