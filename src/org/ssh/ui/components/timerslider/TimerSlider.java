 ...
 * some {@link CheckBox checkboxes} that can be checked to show the goaltimes and timeouts.
 * The amount of {@link CheckBox checkboxes} can be extended in the future of course.
 * Also makes use of FXML.
 * 
