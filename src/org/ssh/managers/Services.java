...
public final class Services {
    ...
    /**
     * Adds a org.ssh.services.pipeline that can be used by a {@link org.ssh.services.pipeline.Producer}, {@link org.ssh.services.pipeline.Coupler}, or {@link org.ssh.services.pipeline.Consumer}. 
     *
     * @param org.ssh.services.pipeline The org.ssh.services.pipeline to be added.
     * @return         true, if successful.
     * @see            org.ssh.services.ServicesController#addPipeline(Pipeline)
     */
    public static boolean addPipeline(Pipeline<?> pipeline) {
        Services.logger.info("Adding org.ssh.services.pipeline<%s>: %s", pipeline.getType(), pipeline.getClass().getName());
     ...
     *
     * @param org.ssh.pipelines The org.ssh.pipelines to be added.
     */
    @SafeVarargs
     ...
     *
     * @param org.ssh.services The org.ssh.services to be added.
     */
    @SafeVarargs
    ...
    /**
     * Gets a List of available {@link org.ssh.services.pipeline.Consumer} compatible with the given {@link org.ssh.services.Pipeline}.
     *
     * @param <T>      The generic type of the {@link org.ssh.services.pipeline.PipelinePacket} handled by the Consumer and Service.
     * @param org.ssh.services.pipeline The given org.ssh.services.pipeline.
    ...
    /**
     * Gets a List of available {@link org.ssh.services.pipeline.Coupler} compatible with the given {@link org.ssh.services.Pipeline}.
     *
     * @param <T>      The generic type of the {@link org.ssh.services.pipeline.PipelinePacket} handled by the Coupler and Service.
     * @param org.ssh.services.pipeline The given org.ssh.services.pipeline.
    ...
    /**
     * Gets a List of available {@link org.ssh.services.pipeline.Producer} compatible with the given {@link org.ssh.services.Pipeline}.
     *
     * @param <T>      The generic type of the {@link org.ssh.services.pipeline.PipelinePacket} handled by the Producer and Service.
     * @param org.ssh.services.pipeline The given org.ssh.services.pipeline.
    ...
    /**
     * Gets a list of {@link org.ssh.services.Pipeline} that operates on the supplied Type of {@link org.ssh.services.pipeline.PipelinePacket}.
     *
     ...
     * execution.
     *
     * @param <T>      The generic type of {@link org.ssh.services.pipeline.PipelinePacket} which the Runnable produces.
    ...
    /**
     * Finds all org.ssh.services matching the name and returns them as an
     * ArrayList<Service>.
     *
