 ...
 * 
 * A ManagerController is used by a Manager to operate on Manageables. Since a Manager
 * is static and final another class is needed to operate on dynamic data.
 *
...
public abstract class ManagerController<M extends Manageable> {
     ...
     *
     * @param name The name of the Manageables
     ...
     *
     * @param manageable the Manageable to be a dded
