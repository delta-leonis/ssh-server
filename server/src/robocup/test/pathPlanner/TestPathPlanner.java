...
public class TestPathPlanner extends DijkstraPathPlanner {
	...
	public void testLockedInSource(){
		...
		assertNull("Test Locked In Source", planner.getRoute(new FieldPoint(0,0), destination, 0, 0, false, false));
	...
	public void testIntersectObject(Vertex source, Vertex destination,
		...
		generateObjectList(0, 0, false, false); // Generate from RobotID's perspective.
