		...
		for(Robot robot : robots){
			if (robot.getPosition() != null) {
				...
				g2.fillArc(
						...
						(int) robotOrientation + (mirror ?  230: 50), 280);
				g2.fillPolygon(new int[] {(int) right.toGUIPoint(ratio, mirror).getX() + spaceBufferX, (int) left.toGUIPoint(ratio, mirror).getX() + spaceBufferX, (int) robotPosition.toGUIPoint(ratio, mirror).getX() + spaceBufferX},
						new int[] {(int) right.toGUIPoint(ratio, mirror).getY() + spaceBufferY, (int) left.toGUIPoint(ratio, mirror).getY() + spaceBufferY, (int) robotPosition.toGUIPoint(ratio, mirror).getY() + spaceBufferY}, 3);
